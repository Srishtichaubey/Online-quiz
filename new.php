...
<div class="row">
<div class="col-lg-6">
<span class="logo" style="margin-top:10px;">Know Your Skill</span></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      ...
      <div class="modal-body">
        <form class="form-horizontal" action="first_db_3.php" method="POST">
<fieldset>
...
<!-- sign in form begins -->  
  <form class="form-horizontal" name="form" action="second_db_2.php" onSubmit="return validateForm()" method="POST">
<fieldset>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="col_name"></label>  
  <div class="col-md-12">
  <input id="col_name" name="col_name" placeholder="Enter your college name" class="form-control input-md" type="text">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="mob_no"></label>  
  <div class="col-md-12">
  <input id="mob_no" name="mob_no" placeholder="Enter your mobile number" class="form-control input-md" type="number">
...
<div class="form-group">
  <label class="col-md-12control-label" for="con_pass"></label>
  <div class="col-md-12">
    <input id="con_pass" name="con_pass" placeholder="Conform Password" class="form-control input-md" type="password">
