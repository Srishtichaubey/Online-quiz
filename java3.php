...
<script src="js/jquery.js" type="text/javascript"></script>
 ...
 <!--<script src="js/phpdb.js" type="text/javascript"></script>-->
 <script>
 function java(){
...
<div class="row">
<div class="col-sm-12">
<input id = "button" type = "button" value = "submit" style="background:orange; border:1px solid;" onclick = "java()">
</div></div>
</form>
<div id = "after_submit">
...
<div class="col-md-3 box"><button data-toggle="modal" data-target="#aboutus">
