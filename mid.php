...
<?php echo '<span class="pull-right top title1" ><span class="log1"><a href="new.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
?></div>
</div></div>
...
<a href="c1.php"><img src="pic/c.png" alt="C"></a>
</div>
<div class="col col-md-3">
<a href="java.php"><img src="pic/icon/java.png" alt="Java"></a>
</div>
<div class="col col-md-3">
<a href="php.php"><img src="pic/php.jpg" alt="PHP"/></a>
</div>
<div class="col col-md-3">
<a href="python.php"><img src="pic/python.jpg" alt="Python"/></a>
</div>
</div></div>
</center>
</div>
