...
<script src="js/jquery.js" type="text/javascript"></script>
 <script src="log5_db.js" type="text/javascript"></script>
...
<div class="row">
<div class="col-md-12">
<form id = "quiz" name = "quiz" style= "background:#b3a990; font-style:sarif; margin-left:5px; width:300px; height:400px; border:1px solid;">
<p class = "questions">PHP is-</p>
<input type = "radio" id = "mc" name = "question2" value = "HP">Hypertext preprocessor<br>
