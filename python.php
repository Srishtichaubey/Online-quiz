...
<div class="row">
<div class="col-sm-12">
<h2 style="color:orange;"><center><b><u>PYTHON QUIZ:- Level 1</u><b></center></h2>
</div>
</div>
<div class="row">
<div class="col-md-12">
...
<input type = "radio" id = "mc" name = "question1" value = "GVR">Guido van Rossum<br>
<input type = "radio" id = "mc" name = "question1" value = "Patrick Naughton">Patrick Naughton<br>
...
<div class="row">
<div class="col-lg-12">
<input id = "button" type = "button" value = "submit" style="background:orange; border:1px solid;" onclick="pyt()"></div></div>
</form>
<div id = "after_submit">
...
About us</h4>
<img src="pic/ic/about.png" style="height:40px;width:40px;margin-left:30px;text-decoration:none;"></a>
</div>
