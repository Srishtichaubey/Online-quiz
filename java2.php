...
<script src="js/jquery.js" type="text/javascript"></script>
 <script src="java2db.js" type="text/javascript"></script>
...
About us</h4>
<img src="pic/ic/about.png" style="height:40px;width:40px;margin-left:30px; background:none; text-decoration:none;"></a>
</div>
