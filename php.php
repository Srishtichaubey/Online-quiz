...
<div class="row">
<div class="col-sm-12">
<h2 style="color:orange;"><center><b><u>PHP QUIZ:- Level 1</u><b></center></h2>
</div>
</div>
<div class="row">
<div class="col-md-12">
<form id="quiz" name = "quiz" style= "background:#b3a990; margin-top:10px; margin-bottom:10px; margin-left:200px; font-style:sarif; width:400px; height:470px; border:1px solid;">

<p class = "questions">PHP is-</p>
<input type = "radio" id = "mc" name = "question1" value = "HP">Hypertext preprocessor<br>
<input type = "radio" id = "mc" name = "question1" value = "PHP">Personal Home Page<br>

<p class = "questions">When was PHP developed?</p>
<input type = "radio" id = "mc" name = "question2" value = "1995">1995<br>
<input type = "radio" id = "mc" name = "question2" value = "1997">1997<br>

<p class = "questions">What is the keyword to print a data in php?</p>
<input type = "radio" id = "mc" name = "question3" value = "println">println<br>
...
<input type = "radio" id = "mc" name = "question5" value = "ODP">On different platforms<br>
<input type = "radio" id = "mc" name = "question5" value = "OSP">On same plateform<br><br>
<div class="row">
<div class="col-lg-12">
<input id = "button" type = "button" value = "submit" style="background:orange; border:1px solid;" onclick="chk()"></div></div>
</form>
<div id = "after_submit">
...
About us</h4>
<img src="pic/ic/about.png" style="height:50px;width:50px;margin-left:30px;text-decoration:none;"></a>
</div>
